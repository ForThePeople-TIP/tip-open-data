...
|------|-------------|------|
| federal_bills | Federal legislation (119th Congress) | 8,471 |
...
| federal_floor_votes | Congressional roll call votes | 188,879 |
...
| pfp_predictions | Multi-factor vote predictions per official per bill | 63,777 |
...
Weekly (Sundays). Last refreshed: **2026-05-17**.
