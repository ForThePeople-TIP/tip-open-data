...
|------|-------------|------|
| federal_bills | Federal legislation (119th Congress) | 10,637 |
...
| federal_floor_votes | Congressional roll call votes | 216,298 |
...
| pfp_predictions | Multi-factor vote predictions per official per bill | 71,877 |
...
Weekly (Sundays). Last refreshed: **2026-06-28**.
