...
|------|-------------|------|
| federal_bills | Federal legislation (119th Congress) | 17,782 |
...
| federal_floor_votes | Congressional roll call votes | 239,345 |
...
| pfp_predictions | Multi-factor vote predictions per official per bill | 75,117 |
...
Weekly (Sundays). Last refreshed: **2026-07-26**.
