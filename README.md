...
|------|-------------|------|
| federal_bills | Federal legislation (119th Congress) | 17,943 |
...
| federal_floor_votes | Congressional roll call votes | 240,129 |
...
Weekly (Sundays). Last refreshed: **2026-08-02**.
