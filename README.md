...
|------|-------------|------|
| federal_bills | Federal legislation (119th Congress) | 8,649 |
...
| federal_floor_votes | Congressional roll call votes | 196,353 |
...
| pfp_predictions | Multi-factor vote predictions per official per bill | 66,477 |
...
Weekly (Sundays). Last refreshed: **2026-05-24**.
