...
|------|-------------|------|
| federal_bills | Federal legislation (119th Congress) | 9,498 |
...
| federal_floor_votes | Congressional roll call votes | 205,411 |
...
| pfp_predictions | Multi-factor vote predictions per official per bill | 68,637 |
...
Weekly (Sundays). Last refreshed: **2026-06-07**.
